...
char* item_search(int block, int block_id){
    ...
    char *sq_name_cpy= "/mnt/e/bsc/bsc d results/compressed_seqname_";
    char *src_name_cpy="/mnt/e/bsc/bsc d results/compressed_source_";    
    char *fea_name_cpy="/mnt/e/bsc/bsc d results/compressed_feature_";
    char *start_name_cpy="/mnt/e/bsc/bsc d results/compressed_start_";
    char *delta_name_cpy="/mnt/e/bsc/bsc d results/compressed_delta_";
    char *score_name_cpy="/mnt/e/bsc/bsc d results/compressed_score_";
    char *strand_name_cpy="/mnt/e/bsc/bsc d results/compressed_strand_";
    char *att_name_cpy="/mnt/e/bsc/bsc d results/compressed_attribure_";
    char *frame_cds_name_cpy="/mnt/e/bsc/bsc d results/compressed_frame_cds_";
    char *frame_start_name_cpy="/mnt/e/bsc/bsc d results/compressed_frame_start_";
    char *frame_stop_name_cpy="/mnt/e/bsc/bsc d results/compressed_frame_stop_";
	char sq_name[100];
    char src_name[100]; 
    char fea_name[100];
    char start_name[100];
    ...
    char* cmd_prefix= "/mnt/e/bsc/bsc d ";
	char* cmd_suffix_sq= "decompressed/decompressed_seqname.txt";
    char* cmd_suffix_src="decompressed/decompressed_source.txt";    
    char* cmd_suffix_fea="decompressed/decompressed_feature.txt";
    char* cmd_suffix_start="decompressed/decompressed_start.txt";
    char* cmd_suffix_delta="decompressed/decompressed_delta.txt";
    char* cmd_suffix_score="decompressed/decompressed_score.txt";
    char* cmd_suffix_strand="decompressed/decompressed_strand.txt";
    char* cmd_suffix_att="decompressed/decompressed_attribure.txt";
    char* cmd_suffix_frame_cds="decompressed/decompressed_frame_cds.txt";
    char* cmd_suffix_frame_start="decompressed/decompressed_frame_start.txt";
    char* cmd_suffix_frame_stop="decompressed/decompressed_frame_stop.txt";
    char* gene ="gene";
